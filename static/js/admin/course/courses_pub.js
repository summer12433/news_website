$(function () {
  ...
  QINIU.upload({
    "domain": "http://new-site.s3-cn-east-1.qiniucs.com/",  // 七牛空间域名
  ...
  const CONFIG = {
  endpoint: 'https://console.bce.baidu.com/',  // 默认区域名
  credentials: {
    ak: '2219f5c549b5445f86d75c3bff123028',     // 填写你的百度云中ak和sk
    sk: '1bb080fd77be4996bf93058fdc24b473'    // 在百度vod 安全认证里面
  }
  };
      // 百度云vod域名在多媒体/全局设置/发布设置里面
  let BAIDU_VOD_DOMAIN = 'newsite.cdn.bcebos.com'; // 百度云VOD域名
